                    ...
                    <table class="table-fixed w-full">
                        <thead class="bg-blue-500">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-white w-auto">Alamat</th>
                                <th class="px-4 py-2 text-white w-auto">Jenis Kelamin</th>
                                <th class="px-4 py-2 text-white w-auto">Kontak</th>
                        ...
                        <tbody>
                            ...
                            <tr>          
                                <td class="px-2 py-3">{{ $customers->firstitem() + $key }}</td>
                                <td>{{ $customer->nama }}</td>
                                 <td>{{ $customer->alamat }}</td>
                                 <td>{{ $customer->kelamin}}</td>
                                 <td>{{ $customer->no_telp }}</td>
                                 <td>{{ $customer->email_customer }}</td>
                                <td>
                                    <button wire:click="edit({{ $customer->id }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded">
                                    Edit
                                    </button>
                                    <button wire:click="delete({{ $customer->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-4 rounded">
                                    Delete
                                    </button>
                                </td>
                            </tr>
